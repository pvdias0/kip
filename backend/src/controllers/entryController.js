...
import { emitTransactionCreated, emitTransactionUpdated, emitTransactionDeleted, emitStatsUpdated } from '../utils/socket.js';
...
export const getStats = async (req, res) => {
  try {
    ...
    let query = 'SELECT type, SUM(amount) as total FROM entries WHERE user_id = $1';
    const params = [userId];
